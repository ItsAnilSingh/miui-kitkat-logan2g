...
.method private constructor <init>(Landroid/app/ContextImpl;Landroid/app/ActivityThread;Landroid/app/LoadedApk;Landroid/os/IBinder;Landroid/os/UserHandle;ZLandroid/view/Display;Landroid/content/res/Configuration;Ljava/lang/String;)V
    ...
    .local v7, compatInfo:Landroid/content/res/CompatibilityInfo;
    if-eqz p1, :cond_1
    ...
    invoke-virtual {v1, v7}, Landroid/view/DisplayAdjustments;->setCompatibilityInfo(Landroid/content/res/CompatibilityInfo;)V
    ...
    iget v1, v7, Landroid/content/res/CompatibilityInfo;->applicationScale:F
    ...
    invoke-virtual {p3}, Landroid/app/LoadedApk;->getAppDir()Ljava/lang/String;

    move-result-object v5

    iget-object v9, p0, Landroid/app/ContextImpl;->mOuterContext:Landroid/content/Context;

    move-object/from16 v6, p8

    move-object/from16 v8, p4

    invoke-virtual/range {v1 .. v9}, Landroid/app/ResourcesManager;->getTopLevelResources(Ljava/lang/String;[Ljava/lang/String;ILjava/lang/String;Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;Landroid/os/IBinder;Landroid/content/Context;)Landroid/content/res/Resources;
    ...
    invoke-virtual/range {v2 .. v8}, Landroid/app/ResourcesManager;->getTopLevelThemedResources(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Landroid/content/res/CompatibilityInfo;Landroid/os/IBinder;)Landroid/content/res/Resources;
...
.method public createPackageContextAsUser(Ljava/lang/String;Ljava/lang/String;ILandroid/os/UserHandle;)Landroid/content/Context;
    ...
    invoke-virtual {v1, p1, v2, p3, v4}, Landroid/app/ActivityThread;->getPackageInfo(Ljava/lang/String;Landroid/content/res/CompatibilityInfo;II)Landroid/app/LoadedApk;
